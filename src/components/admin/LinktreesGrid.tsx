...
const LinktreeCard = memo(function LinktreeCard({
  ...
  return (
    <div 
      className="group relative bg-white border border-gray-200 rounded-xl sm:rounded-2xl p-3 sm:p-5 hover:shadow-lg hover:shadow-gray-200/50 hover:border-gray-300 transition-all duration-300 transform-gpu"
      style={{
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 pt-2 sm:pt-3 border-t border-gray-200">
        {onViewAnalytics && (
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg sm:rounded-xl bg-sky-500/10 hover:bg-sky-500/20 border border-sky-500/30 text-sky-700 hover:text-sky-800 transition-all duration-200 text-xs font-medium"
        ...
        {onEdit && (
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg sm:rounded-xl bg-yellow-500/10 hover:bg-yellow-500/20 border border-yellow-500/30 text-yellow-700 hover:text-yellow-800 transition-all duration-200 text-xs font-medium"
            aria-label="Edit"
            title="دەستکاریکردن"
          >
        ...
        {onDelete && item.uid !== "bahroz" && (
          <button
            onClick={() => onDelete(item.id, item.uid, item.name)}
            className="flex items-center justify-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg sm:rounded-xl bg-[#7E0001]/10 hover:bg-[#7E0001]/20 border border-[#7E0001]/30 text-[#7E0001] hover:text-[#7E0001] transition-all duration-200 text-xs font-medium"
            aria-label="Delete"
            title="سڕینەوە"
          >
