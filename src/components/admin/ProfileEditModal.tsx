...
export function ProfileEditModal({
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="relative p-4 sm:p-5 md:p-6 border-b border-gray-100/50 bg-linear-to-r from-white to-[#7E0001]/10">
          <div className="flex items-start justify-between gap-3 sm:gap-4">
            <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
              <div className="p-2.5 sm:p-3 rounded-xl bg-linear-to-br from-[#7E0001]/10 to-[#7E0001]/10 border border-[#7E0001]/30 shrink-0 shadow-sm">
                <User className="h-5 w-5 sm:h-6 sm:w-6 text-[#7E0001]" />
              </div>
        ...
        <div className="flex items-center gap-2 p-3 sm:p-4 md:p-5 border-b border-gray-100/50 bg-linear-to-r from-slate-50/50 to-gray-50/50">
          <button
            ...
            className={`group relative flex-1 flex items-center justify-center gap-2 px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl text-xs sm:text-sm font-medium font-kurdish transition-all duration-300 disabled:opacity-50 ${
              activeTab === "username"
                ? "bg-linear-to-r from-[#7E0001] via-[#7E0001] to-[#7E0001] text-white border border-[#7E0001] shadow-lg"
            ...
            <form onSubmit={handleUpdateUsername} className="space-y-4 sm:space-y-5">
              <div>
                ...
                <input
                  ...
                  disabled={isLoading}
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl bg-white/80 backdrop-blur-sm border border-slate-200 text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#7E0001]/30 focus:border-[#7E0001] disabled:opacity-50 disabled:cursor-not-allowed font-kurdish transition-all duration-300 shadow-sm hover:shadow-md"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    disabled={isLoading}
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 pr-11 sm:pr-12 rounded-xl bg-white/80 backdrop-blur-sm border border-slate-200 text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#7E0001]/30 focus:border-[#7E0001] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 shadow-sm hover:shadow-md"
