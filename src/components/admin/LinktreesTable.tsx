...
const TableRow = memo(function TableRow({
  ...
  return (
    <tr 
      className="border-b border-gray-200 bg-white hover:bg-gray-50 transition-colors duration-200 transform-gpu"
      style={{
        ...
        <div className="flex items-center gap-1 sm:gap-1.5 flex-wrap justify-start">
          {onViewAnalytics && (
            <button
              ...
              className="p-1 sm:p-1.5 rounded hover:bg-sky-50/60 transition-colors duration-200 shrink-0"
          ...
          {onDelete && item.uid !== "bahroz" && (
            <button
              ...
              className="p-1 sm:p-1.5 rounded hover:bg-[#7E0001]/10 transition-colors duration-200 shrink-0"
              aria-label="Delete"
              title="سڕینەوە"
            >
              <Trash2 className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-[#7E0001] hover:text-[#7E0001]" />
            </button>
          )}
        </div>
      </td>
...
const MobileCard = memo(function MobileCard({ 
  ...
  return (
    <div 
      className="border-b border-gray-200 bg-white p-4 flex gap-4 hover:bg-gray-50 transition-colors duration-200 transform-gpu" 
      ...
      <div className="flex-1 space-y-2">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs text-gray-700">
          ...
          >
            ...
            <span className="font-mono">{item.uid === "bahroz" ? "/" : `/${item.uid}`}</span>
          </button>
