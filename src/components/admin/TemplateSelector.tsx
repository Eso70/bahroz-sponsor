  ...
  return (
    <button
      ...
      className={`group relative aspect-4/3 w-full overflow-hidden rounded-xl border-2 transition-all duration-300 ${
        isSelected
          ? "border-[#7E0001] shadow-lg ring-2 ring-[#7E0001]/30 scale-105"
          : "border-slate-200 hover:border-[#7E0001]/40 hover:shadow-md hover:scale-102"
      }`}
    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-center gap-1 p-1.5 sm:p-2 h-full">
        ...
        {/* Selection checkmark */}
        {isSelected && (
          <div className="absolute top-0.5 right-0.5 sm:top-1 sm:right-1 rounded-full bg-linear-to-br from-[#7E0001] to-[#7E0001] p-0.5 shadow-lg">
        ...
        <div className="border-b border-gray-100/50 bg-linear-to-r from-white to-[#7E0001]/10">
          <div className="flex items-center justify-between p-3 sm:p-4">
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="rounded-xl bg-linear-to-br from-[#7E0001]/10 to-[#7E0001]/10 border border-[#7E0001]/30 p-1.5 sm:p-2 shadow-sm">
                <Sparkles className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-[#7E0001]" />
              </div>
              <div>
