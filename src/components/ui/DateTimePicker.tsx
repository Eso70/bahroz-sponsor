  ...
  return (
    <div ref={containerRef} className="relative">
      <div
        ...
        className={`w-full rounded-xl px-3 py-2 sm:px-4 sm:py-2.5 text-sm text-left bg-linear-to-br from-white to-slate-50/50 border border-slate-200 shadow-sm transition-all duration-300 focus-within:outline-none focus-within:ring-2 focus-within:ring-[#7E0001]/30 focus-within:border-[#7E0001] cursor-pointer flex items-center gap-2 hover:shadow-md hover:border-[#7E0001]/30 ${className}`}
        style={style}
        onFocus={onFocus}
        onBlur={onBlur}
      >
                        ...
                        <button
                          ...
                          className={`px-3 py-2 rounded-xl text-sm transition-all duration-300 ${
                            isPast
                              ...
                              : isSelected
                              ? "bg-linear-to-br from-[#7E0001] to-[#7E0001] text-white shadow-lg font-semibold"
                              : "text-slate-600 hover:bg-linear-to-br hover:from-slate-50 hover:to-gray-50 border border-slate-100 hover:border-[#7E0001]/30"
                          }`}
                        >
                          {year}
                        </button>
              ...
              <>
                ...
                <div className="flex items-center justify-between mb-4 gap-2">
                  ...
                  <button
                    ...
                    className="text-lg font-semibold text-slate-700 hover:text-[#7E0001] transition-colors duration-300 px-3 py-1 rounded-xl hover:bg-linear-to-br hover:from-[#7E0001]/10 hover:to-[#7E0001]/10 border border-transparent hover:border-[#7E0001]/30"
                  >
                    ...
                    return (
                      <button
                        ...
                        className={`aspect-square rounded-xl text-sm transition-all duration-300 ${
                          isSelected
                            ? "bg-linear-to-br from-[#7E0001] to-[#7E0001] text-white shadow-lg scale-105 font-semibold"
                            : isCurrentDay
                            ? "bg-linear-to-br from-[#7E0001]/10 to-[#7E0001]/10 text-[#7E0001] font-semibold border-2 border-[#7E0001]/40"
