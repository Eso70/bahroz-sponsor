  ...
  return (
    <button
      ...
      className={`w-full px-4 py-3 text-left text-sm transition-all duration-300 rounded-xl transform-gpu ${
        isSelected
          ? "bg-linear-to-r from-[#7E0001]/10 to-[#7E0001]/10 text-[#7E0001] dark:text-[#7E0001] border-l-4 border-[#7E0001] shadow-md font-semibold"
          : "text-slate-600 dark:text-gray-300 hover:bg-linear-to-r hover:from-slate-50 hover:to-gray-50 hover:text-slate-700 dark:hover:from-[#1c1e28] dark:hover:to-[#1c1e28] dark:hover:text-gray-150"
      }`}
      style={{
        contentVisibility: "auto",
        containIntrinsicSize: "46px",
      }}
    >
...
export function CountrySelector({
  ...
  if (!mounted) {
    return (
      <button
        type="button"
        className={`flex items-center justify-between gap-2 rounded-xl border border-slate-200 dark:border-white/10 bg-linear-to-br from-white to-slate-50/50 dark:from-[#0d0e13] dark:to-[#0d0e13] px-3 py-2 text-sm text-slate-700 dark:text-gray-200 transition-all duration-300 hover:border-[#7E0001]/30 dark:hover:border-[#7E0001]/50 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-[#7E0001]/30 min-w-25 shadow-sm ${className}`}
      >
  ...
  const modalContent = isOpen ? (
    <>
      ...
      >
        {/* Header */}
        <div className="border-b border-gray-100/50 bg-linear-to-r from-white to-[#7E0001]/10">
          <div className="flex items-center justify-between p-4 sm:p-5">
            <div className="flex items-center gap-3">
              <div className="rounded-xl bg-linear-to-br from-[#7E0001]/10 to-[#7E0001]/10 border border-[#7E0001]/30 p-2 shadow-sm">
                <Globe className="h-4 w-4 text-[#7E0001]" />
              </div>
              <div>
        ...
        <div className="p-3 sm:p-4 border-b border-gray-100/50 bg-linear-to-br from-white to-slate-50/20">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-9 py-2.5 rounded-xl bg-white/80 backdrop-blur-sm border border-slate-200 text-sm text-slate-700 placeholder-slate-400 focus:outline-none focus:border-[#7E0001] focus:ring-2 focus:ring-[#7E0001]/30 transition-all duration-300 shadow-sm hover:shadow-md"
            />
            {searchQuery && (
              <button
                type="button"
        ...
        <div 
          ...
          className="overflow-y-auto p-2 bg-linear-to-br from-white to-slate-50/20 transform-gpu"
          style={{ 
            scrollbarWidth: "thin", 
